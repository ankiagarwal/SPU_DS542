...
def flip_coin():
    ...
    return coin_toss   ## fixed the variable name coin_toss 
...
def guess_coin_flip():
    ...
    if user_guess == coin_flip:    ### fixed syntex error in this line
        print(f"correct! you guessed {user_guess} and the coin landed on {coin_flip}")  ##fixed error in user_guess typo
        correct_guess = True
